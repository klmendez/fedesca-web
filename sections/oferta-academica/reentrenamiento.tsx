      ...
      <div className="py-14">
        ...
        <div className="mx-auto max-w-3xl space-y-3 text-left">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
            Jornadas intensivas, modulares y rotativas para reforzar habilidades tácticas, éticas y tecnológicas,
        ...
        <div className="mx-auto mt-12 max-w-5xl">
          ...
          {programs.map((program, index) => (
            <div key={program.id} className="grid items-start gap-10 py-10 lg:grid-cols-[1.1fr_0.9fr]">
              {/* TEXTO DEL MÓDULO (más grande, como formal) */}
              <div className="space-y-3">
                ...
                {/* micro-info sin pills */}
                <p className="text-sm text-muted-foreground">
                  Actualización anual · Certificación al finalizar
                </p>
              </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-3">
          <Link href="/landing/reentrenamiento" className="btn btn-secondary !px-7 !py-3 !text-base">
            Ver más información
          </Link>
